    ...
    public function allForIndex(array $filters = []): Collection
    {
        return EventoSignificativo::query()
            ->with([
                ...
                'user:id,name,email',
                'facturas:id,evento_significativo_id,evento_significativo_paquete_id,venta_id,cliente_id,cafc_id,user_id,numero_factura,cuf,codigo_recepcion,codigo_emision,estado_factura,estado_sincronizacion,codigo_estado,descripcion_estado,monto_total,fecha_emision',
                'facturas.venta:id,numero_venta',
    ...
    public function findForProcess(EventoSignificativo $evento): EventoSignificativo
    {
        return EventoSignificativo::query()
            ->with([
                ...
                'cafc' => $this->cafcRelation(),
                'user:id,name,email',
                'facturas:id,evento_significativo_id,evento_significativo_paquete_id,cafc_id,venta_id,fecha_emision,estado_factura,estado_sincronizacion,codigo_recepcion,numero_factura,cuf,xml_fiscal',
                'facturas.venta:id,estado_facturacion,codigo_recepcion',
                'facturas.cafc:id,codigo',
                'paquetes.cufdEnvio:id,codigo,codigo_control,fecha_vigencia',
                'paquetes.facturas:id,evento_significativo_paquete_id,venta_id,numero_factura,estado_sincronizacion',
                'reportes.user:id,name,email',
            ])
            ->lockForUpdate()
