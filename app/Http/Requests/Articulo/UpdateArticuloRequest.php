...
class UpdateArticuloRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'codigo_generico' => ['required', 'string', 'max:100', Rule::unique('articulos', 'codigo_generico')->ignore($articuloId)],
            'codigo_barras' => ['nullable', 'string', 'max:100', Rule::unique('articulos', 'codigo_barras')->ignore($articuloId)],
