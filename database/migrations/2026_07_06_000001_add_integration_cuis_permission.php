...
{
    private string $permissionSlug = 'integracion.cuis.manage';
    ...
    public function up(): void
    {
        DB::table('permisos')->updateOrInsert(
            ...
            [
                'nombre' => 'API integracion CUIS',
                'modulo' => ModuloSistemaEnum::FACTURACION->value,
                'descripcion' => 'Permite consultar y asegurar CUIS desde la API externa de integracion.',
                'estado' => true,
                'created_at' => now(),
                'updated_at' => now(),
            ],
